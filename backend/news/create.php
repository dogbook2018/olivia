...
if(isset($_FILES['picture']['name'])){
  ...
  $sql= "INSERT INTO news  (published_date, title, picture, content, created_at) VALUES ( :published_date, :title, :picture, :content, :created_at)";
  $sth = $db ->prepare($sql);
      ...
      <div class="row">
        <div class="col-md-12 text-left">
          <ul class="breadcrumb" style="margin-bottom: 0px; margin-top: 0px;">
            ...
            <li class="breadcrumb-item">花藝分享管理</li>
