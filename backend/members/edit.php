      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="form-group form-row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="name" value="<?php echo $members['name']; ?>" >
                </div>
            </div>
          ...
          <div class="form-group form-row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="account" value="<?php echo $members['account']; ?>" >
                </div>
            </div>
            <div class="form-group form-row">
              <label class="col-sm-2 col-form-label">密碼</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="password" value="<?php echo $members['password']; ?>">
                </div>
            </div>
            <div class="form-group form-row">
            ...
            <div class="form-group form-row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="mobile" value="<?php echo $members['mobile']; ?>" >
                </div>
            </div>
            <div class="form-group form-row">
              <label class="col-sm-2 col-form-label">生日</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="birthday" value="<?php echo $members['birthday']; ?>">
                </div>
            </div>
            <div class="form-group form-row">
              <label class="col-sm-2 col-form-label">性別</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="gender" value="<?php echo $members['gender']; ?>">
                </div>
            </div>
            <div class="form-group form-row">
            ...
            <div class="form-group form-row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="county" value="<?php echo $members['county']; ?>">
            ...
            <div class="form-group form-row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="district" value="<?php echo $members['district']; ?>">
                <div class="help-block with-errors" alert-danger></div>
                </div>
            </div>
            <div class="form-group form-row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="address" value="<?php echo $members['address']; ?>">
                <div class="help-block with-errors" alert-danger></div>
                </div>
            </div>
            <div class="form-group form-row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="vip" value="<?php echo $members['vip']; ?>">
                </div>
            </div>
            <div class="form-group form-row">
            ...
            <div class="form-group form-row">
              ...
              <div class="col-sm-10">
              <pclass="form-control"><?php echo $members['created_at'];?></p> </div>
            </div>
