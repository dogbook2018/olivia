...
if(isset($_POST['EditForm']) && $_POST['EditForm'] == "UPDATE"){
  if(isset($_FILES['picture']['name']) && $_FILES['picture']['name']!=null){
    unlink("../../uploads/category/".$_POST['old_picture']);
  ...
  $sql= "UPDATE product_categories SET picture=:picture, category=:category, updated_at=:updated_at WHERE product_categories_id=:product_categories_id";
  $sth = $db ->prepare($sql);
...
<body>
  ...
  <div class="py-5 text-center">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <form class="" action="edit.php" method="post" data-toggle="validator" enctype="multipart/form-data">

            

             <div class="form-group form-row">
              <label class="col-sm-2 col-form-label">分類圖片</label>
              <div class="col-sm-10">
                <img src="../../uploads/products/<?php echo $product_categories['picture'];?>" alt="">
                <input type="file" class="form-control" name="picture" id="picture">
                <input type="hidden" name="old_picture" value="<?php echo $product_categories['picture'];?>">
              </div>
</div>
            <div class="form-group form-row">
