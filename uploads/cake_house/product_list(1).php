 ...
 _________________________________________________________ -->
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            ...
                            <?php foreach($categories as $side_categories){  ?>
                                <li>
                                    <a href="category.php"><?php echo $side_categories['category']; ?> <span class="badge pull-right">42</span></a>
                ...
                <?php foreach($product_list as $product){?>
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="product.php?<?php echo $product['products_id'];?>"><?php echo $product['name'];?></a></h3>
