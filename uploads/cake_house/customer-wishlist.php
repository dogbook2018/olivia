                    ...
                    <div class="row products">
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="order_detail.php">Fur coat with very but very very long name</a></h3>
                                    <p class="price">$143.00</p>
                                    <p class="buttons">
                                        <a href="order_detail.php" class="btn btn-default">View detail</a>
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="order_detail.php">White Blouse Armani</a></h3>
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="order_detail.php">Black Blouse Versace</a></h3>
                                    <p class="price">$143.00</p>
                                    <p class="buttons">
                                        <a href="order_detail.php" class="btn btn-default">View detail</a>
                                        <a href="basket.php" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="order_detail.php">White Blouse Versace</a></h3>
                                    <p class="price">$143.00</p>
                                    <p class="buttons">
                                        <a href="order_detail.php" class="btn btn-default">View detail</a>
                                        <a href="basket.php" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="order_detail.php">Fur coat</a></h3>
                                    <p class="price">$143.00</p>
                                    <p class="buttons">
                                        <a href="order_detail.php" class="btn btn-default">View detail</a>
                                        <a href="basket.php" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a>
